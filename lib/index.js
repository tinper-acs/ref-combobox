...
var RefComboBoxBaseUI = (_temp = _class = function (_Component) {
  ...
  RefComboBoxBaseUI.prototype.render = function render() {
    ...
    var _props2 = this.props,
        ...
        _props2$menuIcon = _props2.menuIcon,
        menuIcon = _props2$menuIcon === undefined ? _react2["default"].createElement(
      'span',
      { className: 'uf uf-navmenu' },
      ' '
    ) : _props2$menuIcon,
        _props2$paginationPro = _props2.paginationProps,
        paginationProps = _props2$paginationPro === undefined ? {} : _props2$paginationPro,
        _props2$popupPlacemen = _props2.popupPlacement,
        popupPlacement = _props2$popupPlacemen === undefined ? 'bottomLeft' : _props2$popupPlacemen;
    ...
    var offsetX = Number(sliderWidth) ? Number(sliderWidth) / 2 + 'px' : 200;
